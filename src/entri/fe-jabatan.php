                    ...
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <form action="fe-jabatan.php" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="tj_jabatan" class="form-label">Tunjangan Jabatan</label>
                                        ...
                                        foreach ($jabatan_list as $jabatan) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="submit" name="jabatan" value="<?= $jabatan['kd_jabatan'] ?>" class="btn btn-danger">🗑️</button>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
